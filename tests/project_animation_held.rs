...
use usd_bevy::read::anim::{InterpMode, eval_scalar_track, read_animated_prim};

#[test]
fn held_interpolation_snaps_to_lower_sample() {
    let stage = openusd::usd::Stage::open("tests/stages/animated_held.usda").expect("fixture parses");
